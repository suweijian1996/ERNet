...
class TestDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        unom_img = np.transpose(img /255.0, (2, 0, 1))
        # tmp_inp = np.transpose((img / 255.0)*2-1, (2, 0, 1))
...
def yolo_dataset_collate(batch):
    ...
    unom_imgs = []
    # bboxes = []
    for unom_img in batch:
        # images.append(img)
        unom_imgs.append(unom_img)
        # bboxes.append(box)
    # images = np.array(images)
    unom_imgs = np.array(unom_imgs)
    return unom_imgs
